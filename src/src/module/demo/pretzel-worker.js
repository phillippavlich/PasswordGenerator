var target = 'BhByjNfxlcC6'

var charSet = 'abcdefghijklmnopqrstuvwxyz'
function numberToString (n) {
  var result = []
  var remainder, letter 
  
  while (n > 0) {
    n--
    remainder = n % charSet.length
    letter = charSet[remainder]
    result = letter + result
    n = (n - remainder) / charSet.length
  }
  return result
}
...
function run() {
  ...
  p.setSalt(Array.from(crypto.getRandomValues(new Uint8Array(256))))

  while (!done) {
    for (var i2 =0; i2<100; i2++) { // batches of 100
      i++
      var hash = p.generatePassword(numberToString(i), '')
      if (hash === target) {
        done = true
        self.postMessage({
          method: 'pretzel',
...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.PretzelPass = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
PretzelPass.prototype.setSalt = function (salt) {
  ...
  self._salt = Buffer.from(Array.from(salt))
}
...
},{"./unicode":12,"safe-buffer":3,"sha.js":5}],2:[function(require,module,exports){
...
},{"./sha":6,"./sha1":7,"./sha224":8,"./sha256":9,"./sha384":10,"./sha512":11}],6:[function(require,module,exports){
/*
...
},{"./hash":4,"inherits":2,"safe-buffer":3}],7:[function(require,module,exports){
/*
...
},{"./hash":4,"inherits":2,"safe-buffer":3}],8:[function(require,module,exports){
/**
...
},{"./hash":4,"./sha256":9,"inherits":2,"safe-buffer":3}],9:[function(require,module,exports){
/**
 * A JavaScript implementation of the Secure Hash Algorithm, SHA-256, as defined
 * in FIPS 180-2
 * Version 2.2-beta Copyright Angel Marin, Paul Johnston 2000 - 2009.
...
},{"./hash":4,"inherits":2,"safe-buffer":3}],10:[function(require,module,exports){
var inherits = require('inherits')
...
},{"./hash":4,"./sha512":11,"inherits":2,"safe-buffer":3}],11:[function(require,module,exports){
var inherits = require('inherits')
var Hash = require('./hash')
var Buffer = require('safe-buffer').Buffer
...
},{"./hash":4,"inherits":2,"safe-buffer":3}],12:[function(require,module,exports){
var unicode = {}
